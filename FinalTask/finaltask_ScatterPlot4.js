class ScatterPlot1 {
    ...
    update() {
        ...
        self.xvalue = d => d.Birth_per_woman;
        self.yvalue = d => d.GDP_per_capita_Growth;
    ...
    render() {
        ...
        circles
            .on('mouseover', (e,d) => {
                d3.select('#tooltip')
                    .style('opacity', 1)
                    .html(`<div class="tooltip-label">${d.Country_Name}</div>(${d.Birth_per_woman}, ${d.GDP_per_capita_Grpwth})`);
            })
            .on('mousemove', (e) => {
                const padding = 10;
                d3.select('#tooltip')
